...
RDS protocol. It is more exploratory than functional, so if you are just looking for a quick way to decode RDS you should use something else (eg. [redsea](https://github.com/windytan/redsea))
